...
"""
"""
#a = [ 12, 4, 96, 438, 7, 6, 6, 7, 8, 9, 4, 5, 4, 500, 500 ]
a = [ 1, 2, 3, 4, 5, 7, 6 ]
c = a[0]
d = c
for  i in a:
...
for i in open("fb.py", 'r'):
  match = re.match(r'\d{6}', i)
  if match:
    print(match)
  """
"""
...
"""
a = [ 1, 2, 3 ] #"mshanmukhareddy"
b = [ 1, 2, 3 ] #"mshanmukhareddy"
